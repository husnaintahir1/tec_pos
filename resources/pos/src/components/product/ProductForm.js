...
const ProductForm = (props) => {
    ...
    const [productValue, setProductValue] = useState({
        ...
        code: "",
        product_category_id: "",
        brand_id: {value: 1, label: 'AKMART'},
        barcode_symbol: {value: '1', label: 'Code 128'},
        product_cost: "",
        product_price: "",
        product_unit: {value: 1, label: 'piece'},
        sale_unit: {value: 1, label: 'piece'},
        purchase_unit: {value: 1, label: 'piece'},
        stock_alert: 5,
        order_tax: 0,
        tax_type: {value: 2, label: 'Inclusive'},
        sale_quantity_limit: "",
        notes: "",
        images: [],
        warehouse_id: {value: 1, label: 'warehouse'},
        supplier_id: {value: 1, label: 'AKMART'},
        add_stock: "",
        status_id: {
